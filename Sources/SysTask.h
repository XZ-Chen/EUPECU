...
typedef union _sys_para{
   ...
   struct{
       ...
       struct{
	     ...
	     struct{    //8
	        uint16 StartSp;  //Í£Ö¹¹¤¿öÔËÐÐ×î¸ß×ªËÙ
	        uint16 LowStp;   //Æô¶¯¹¤¿öµÄ×îµÍ×ªËÙ
	        uint16 HiStp;    //Æô¶¯¹¤¿ö×î¸ß×ªËÙ
	        uint16 OilStp;   //Æô¶¯¹¤¿öÖÐ¿ªÊ¼¹©ÓÍ×ªËÙ
	        uint8  HiStCount;     //Í³¼Æ´ÎÊý£º³¬¹ýHiStp
	        uint8  PaTiSt;    //×î¸ßÆô¶¯×ªÊý¼ì²â´ÎÊý
	        uint16 Reversed1;
	      	uint16 Reversed2;
	     }StartCondition_var;
	     struct{    //8
	        ...
	        uint16 PID_Array[4];   //Æô¶¯¹¤¿öÖÐ¿ªÊ¼¹©ÓÍ×ªËÙ
	        uint16 IdGoSp;     //µ¡ËÙÄ¿±ê×ªËÙ
	        uint16 IdGoSpOffset;    //×î¸ßÆô¶¯×ªÊý¼ì²â´ÎÊý
	        uint16 bIdlePID;
	      	uint16 Reversed2;
	     }IdleCondition_var;
