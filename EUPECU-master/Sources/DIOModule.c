...
//4路高位开关端口  PB1 PB2 PB3 PB4                             
static UINT8 *pDIPort[4] =    {&PORTB,&PORTB,&PORTB,&PORTB};
static UINT8 *pDIPortDDR[4] = {&DDRB, &DDRB, &DDRB, &DDRB};
static UINT8 DIPortMask[4] =  {0x02,  0x04,  0x08,   0x10};
